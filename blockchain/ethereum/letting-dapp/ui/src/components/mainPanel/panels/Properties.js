...
const Properties = () => {
  ...
  return (
    <Container>
      <Section>
        <Heading>
          <HeadingText>Properties List</HeadingText>
        </Heading>
        <Content>
          {!propertyList.length
            ? null
            : propertyList.map((property) => (
                <InnerSection key={property.id}>
                  <Row>
                    <FieldText>Address:</FieldText>
                    <ValueText>{property.address}</ValueText>
                  </Row>
                  <DeleteIcon
          ...
          <br />
          <br />
          <InfoText>Add a new property to the list.</InfoText>
          <NewLandlordColumn>
            <ValueInput
